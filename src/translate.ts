...
import type { TranslateConfig, StringObject, translatorType, ILocalsOption } from '../types'
...
const targetLocalePath = getAbsolutePath(process.cwd(), './i18n/en/translation.json')
console.log(targetLocalePath, 'targetLocalePath')
export default async function (
  localePath: string,
  locales: ILocalsOption[],
