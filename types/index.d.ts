...
export interface ILocalsOption {
  locale: string // 翻译的目标语言
  path: string // 翻译的目标语言文件路径
  description?: string // 翻译的描述
}
...
export type Config = {
  ...
  prettier: PrettierConfig | string // 如果传入string，则表示prettier的配置文件路径
  skipExtract: boolean
